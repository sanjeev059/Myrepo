...
JIO_REPO_PATH = '/var/STB/JHSD200/'
IWEDIA = "/scripts_p2/weekly_iwedia_tags.txt"
...
def remove_duplicates():
	os.system("uniq /scripts_p2/weekly_iwedia_tags.txt /scripts_p2/output.txt")
	os.system("mv /scripts_p2/output.txt /scripts_p2/weekly_iwedia_tags.txt")
